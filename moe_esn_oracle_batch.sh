...
#SBATCH --mem=64G
#SBATCH --output=%x-n300-%j.out
#SBATCH --error=%x-n300-%j.err
...
GA_EXPLORE_GENERATIONS=${GA_EXPLORE_GENERATIONS:-5}
...
GA_MUTATION_SCALE_START=${GA_MUTATION_SCALE_START:-1.0}s
...
export ESN_DASK_JOBS=${ESN_DASK_JOBS:-30}
